  ...
  bundles: [
    {
      ...
      assets: {
        ...
        levelBackground: 'assets/levels/Level.png',
        levelSettings: 'assets/levels/Level-settings.json'
      }
    }
  ]
}
...
export class LoaderScene extends Container implements IScene {
  ...
  public getAssets (): {
    ...
    return {
      ...
      levelBackground: Assets.get('levelBackground'),
      levelSettings: Assets.get('levelSettings')
    }
  }
